...
public class OrderController {
    ...
    public ResponseEntity<Order> processPaymentSuccess(
    ...
    public ResponseEntity<Order> processPaymentFailure(
            @RequestParam String paymentId,
    ...
    @PreAuthorize("hasRole('ADMIN')")
    public ResponseEntity<Order> assignToSHG(
            @PathVariable Long orderId,
    ...
    @PreAuthorize("hasAnyRole('ADMIN', 'SHG_DIDI')")
    public ResponseEntity<Order> assignToDeliveryBoy(
            @PathVariable Long orderId,
            @Valid @RequestBody AssignOrderRequest request) {
    ...
    public ResponseEntity<List<Order>> getSHGOrders() {
        return ResponseEntity.ok(orderService.getOrdersByStatus(Order.OrderStatus.PROCESSING));
    }
    ...
    public ResponseEntity<List<Order>> getDeliveryBoyOrders() {
        return ResponseEntity.ok(orderService.getOrdersByStatus(Order.OrderStatus.OUT_FOR_DELIVERY));
    }
}
